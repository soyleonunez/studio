    ...
    const handleDownload = () => {
        ...
        if (input) {
            html2canvas(input, { scale: 2 }).then((canvas) => {
                ...
                pdf.save(`presupuesto-${estimate.id}.pdf`);
            });
        }
    }
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-2xl font-bold tracking-tight">Presupuesto {estimate.id}</h1>
            ...
            <div id="printable-area" className="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-8 my-6">
                    ...
                    <div>
                        <h4 className="font-semibold text-gray-600 mb-2">Paciente</h4>
                        <p className="font-bold text-gray-800">{estimate.pet.name}</p>
                        <p className="text-sm text-gray-500">Raza: {estimate.pet.breed}</p>
                        <p className="text-sm text-gray-500">Edad: {estimate.pet.age}</p>
                        <p className="text-sm text-gray-500">Género: {estimate.pet.gender}</p>
                    </div>
                </div>
                    ...
                    <Table>
                        <TableHeader>
                            <TableRow className="bg-gray-50">
                                <TableHead className="w-1/2">Servicio / Producto</TableHead>
